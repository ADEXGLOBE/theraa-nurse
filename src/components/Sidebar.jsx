...
const navItems = [
  ...
  { key: "meds", label: "Medication", icon: "💊" },
  { key: "staff", label: "Staff Notes", icon: "📝" },
  ...
  return (
    <aside className="pro-sidebar">
      <div className="sidebar-brand">
        ...
        <div>
          <div className="brand-title">Theraa Nurse</div>
          <div className="brand-subtitle">Purpose-Centred Care</div>
        </div>
      </div>
